...
static const StatusCmd statuscmds[] = {
    {"~/.local/bin/statusbar/cpu", 1},
    {"~/.local/bin/statusbar/mem", 2},
    {"~/.local/bin/statusbar/wifi", 3},
};
...
static const Key keys[] = {
    ...
    {MODKEY, XK_r, spawn, SHCMD("/home/nxb1t/.config/rofi/launchers/type-1/launcher.sh")},
